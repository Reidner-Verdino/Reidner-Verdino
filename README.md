...
Looking for my first opportunity as a Data / BI / Analytics Intern or Junior Developer.
...
|---------|-------------|--------------|
| [alura-store-brasil](https://github.com/Reidner-Verdino/alura-store-brasil) | Sales data analysis and visualization for a fictional retail chain | Python, Pandas, Matplotlib |
| [telecom-x-churn-prediction](https://github.com/Reidner-Verdino/telecom-x-churn-prediction) | Customer churn prediction model for a telecom company | Python, Scikit-learn, Pandas |
| [devops-test](https://github.com/Reidner-Verdino/devops-test) | DevOps practices and infrastructure configuration study | Git, Linux |
